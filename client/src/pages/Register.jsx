...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res?.success) {
      toast.success('Profile created successfully! Session initialized.');
      navigate('/dashboard');
    } else {
        ...
        <div className="card-body p-6 md:p-8 flex flex-col gap-6">
          <div className="text-center flex flex-col items-center gap-1">
            ...
            <h2 className="card-title text-2xl font-bold font-display text-base-content">
              Create SentinelScan Account
            </h2>
            <p className="text-xs text-base-content/60">
              Create a local profile to run vulnerability scans.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            >
              {loading ? <span className="loading loading-spinner"></span> : 'Initialize Profile'}
            </button>
          </form>
